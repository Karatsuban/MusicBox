...
from source.view.scripts import Lecteur
...
class Menu(tkinter.Frame):
    ...
    def __init__(self, master, parametres):
        ...
        self.Lecteur = tkinter.Button(self, textvariable=self.textBoutonLecteur, bg = "white", font = self.texte, bd = 1, command=lambda :[self.saveParametres(),self.acces_lecteur(master)])
    ...
    def getParametres(self):
        print("On est dans getParametres !!")
