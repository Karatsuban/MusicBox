...
class Menu(tkinter.Frame):
    ...
    def __init__(self, master, parametres):
		...
		#Création de la varaible contenant le chemin
        ...
        dureeMorceauLabel = tkinter.Label(self, text="Durée de morceaux",height = hauteurBout,  font = self.PoliceTexte, bg='white').grid(row = 3, column =0, sticky="W")
        ...
        dureeMorceauLimit = tkinter.Label(self, text="(5-340)", bg="white").grid(row=3, column=1, sticky="e")


        #Tonalité de morceaux
        tonaliteMorceauLabel = tkinter.Label(self, text="Tonalité de morceaux",height = hauteurBout,  font = self.PoliceTexte, bg='white').grid(row = 4, column =0, sticky="W")
        ...
        vitesseMorceauLabel = tkinter.Label(self, text="Vitesse des morceaux",height = hauteurBout,  font = self.PoliceTexte, bg='white').grid(row = 5, column =0, sticky="W")
        ...
        #Choix de génération
        typeGenerationLabel = tkinter.Label(self, text="Type de génération", width = 15, height = hauteurBout, font = self.PoliceTexte, bg='white').grid(row = 6, column =0, sticky="W")
        ...
        advancedLabel = tkinter.Label(self, text="Choix avancés", bg='white', font=self.policeTitre).grid(row=7,column=0,sticky="W")
        warningLabel = tkinter.Label(self, text="Non recommandé", bg='white', font = self.PoliceTexte).grid(row=8,column=0,sticky="W")
        ...
        varLgSeq.set(self.parametres["LongeurSequence"])
        tkinter.Label(self, text="Longueur séquence",height = hauteurBout, font = self.PoliceTexte, bg='white').grid(row = 13, column =0, sticky="W")
        ...
        #utilisation batch
        tkinter.Label(self, text="Utiliser batch",height = hauteurBout,  font = self.PoliceTexte, bg='white').grid(row = 14, column =0, sticky="W")
        ...
        if(self.parametres["BatchBool"] == "True"):
            self.boolBatch.current(0)
        else:
            self.boolBatch.current(1)
        ...
        tkinter.Label(self, text="Séquence/batch",height = hauteurBout, font = self.PoliceTexte, bg='white').grid(row = 15, column =0, sticky="W")
    ...
    def valide(self):
        ...
        if(int(self.nbMorceaux.get())>20 or int(self.nbMorceaux.get())<1):
            valide = False
        if(int(self.dureeMorceau.get())<5 or int(self.dureeMorceau.get())>340) :
            valide = False
    ...
    def charging(self, master):
        if(self.valide()):
            ...
            master.switch_frame()
            self.textBoutonValider.set("Valider") # à déplacer dans lecteur ?
